    ...
    <div className="p-4">
      ...
      <AlertDialog open={showMergeModal} onOpenChange={(open) => !open && handleMergeCancel()}>
        <AlertDialogContent className="rounded-2xl max-w-sm">
          ...
          <AlertDialogFooter className="!flex-row !items-center gap-2 !justify-center">
            <AlertDialogCancel
              onClick={handleMergeCancel}
              disabled={mergeLoading}
              className="flex-1 h-10 !mt-0 !mb-0 rounded-xl text-sm"
            >
              취소
            </AlertDialogCancel>
            <AlertDialogAction
              ...
              disabled={mergeLoading}
              className="flex-1 h-10 !mt-0 !mb-0 rounded-xl text-sm bg-emerald-600 hover:bg-emerald-700"
            >
              {mergeLoading ? (
