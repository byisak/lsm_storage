...
export default function SuperAdminAuditLogPage() {
  ...
  }, [user, companyFilter, actionFilter, resourceFilter, startDate, endDate])
  ...
  const fetchLogs = async (offset: number) => {
    ...
    try {
      ...
      const res = await fetch(`/api/super-admin/audit-log?${params.toString()}`)
    ...
    <div className="p-4 pb-8">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-xl font-bold text-foreground">시스템 감사 로그</h1>
        </div>
        <p className="text-sm text-muted-foreground">전체 시스템 활동 기록</p>
      </div>
      ...
      >
        <span className="flex items-center gap-2">
          ...
          필터
          {(companyFilter || actionFilter || resourceFilter || startDate || endDate) && (
      ...
      {showFilters && (
        <Card className="border-0 shadow-sm mb-4">
          <CardContent className="p-4 space-y-3">
            <div>
              <label className="text-xs text-muted-foreground mb-1 block">회사 ID</label>
              <Input
                type="text"
                placeholder="회사 ID로 필터링"
                value={companyFilter}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        <span className="text-xs px-2 py-0.5 rounded bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 font-medium flex items-center gap-1">
